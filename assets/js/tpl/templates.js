...
var out='<a href="/page/add">Ajouter une page</a><!--<input type="text" placeholder="Rechercher" id="filter-input" />--><ul>';var arr1=it;if(arr1){var page,index=-1,l1=arr1.length-1;while(index<l1){page=arr1[index+=1];out+='<li data-page-id="'+( page.id )+'">'+( page.title )+'</li>';} } out+='</ul>';return out;
};
